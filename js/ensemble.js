  ...
  try {
    ...
    try {
      ...
      if (uid) {
        ...
        if (user) {
          _state.userName = user.name || user.nick || '\u6211';
          _state.userAvatar = user.avatar || '';
        }
      }
    } catch(e) { console.warn('[ensemble] load user:', e); }
...
async function doAIGenerate(page) {
  ...
  try {
    ...
    msgs.push({ role: 'user', content: '\u7ee7\u7eed\u5267\u60c5\uff0c\u8ba9\u89d2\u8272\u4eec\u81ea\u7136\u4e92\u52a8\u3002' });
...
async function buildGroupPrompt(chars, mode, scriptData) {
  ...
  if (mode !== 'script') {
    try {
      if (window.WanWanMemory && window.WanWanMemory.buildTimeAwarenessContext) {
        var firstCharId = chars && chars.length > 0 ? chars[0].char.id : 0
        var timeCtx = await window.WanWanMemory.buildTimeAwarenessContext(firstCharId)
        if (timeCtx) p += '## 时间感知\n' + timeCtx + '\n\n'
      }
    } catch(e) { /* ignore */ }
  ...
  p += '5. \u6bcf\u6b21\u56de\u590d\u5fc5\u987b\u8ba9\u6240\u6709\u5728\u573a\u89d2\u8272\u90fd\u51fa\u573a\uff0c\u6bcf\u4e2a\u89d2\u8272\u5fc5\u987b\u6709\u81ea\u5df1\u72ec\u7acb\u7684\u6bb5\u843d\uff08\u540d\u5b57+\u52a8\u4f5c+\u53f0\u8bcd\uff09\uff0c\u4e0d\u80fd\u628a\u6240\u6709\u89d2\u8272\u5199\u5728\u540c\u4e00\u6bb5\n';
