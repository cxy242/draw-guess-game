...
var SVG_ICONS = {
  ...
  relationship: '<svg viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg"><circle cx="400" cy="400" r="60" fill="#6b7d8d"/><circle cx="200" cy="200" r="40" fill="#8fa0af"/><circle cx="600" cy="200" r="40" fill="#8fa0af"/><circle cx="200" cy="600" r="40" fill="#8fa0af"/><circle cx="600" cy="600" r="40" fill="#8fa0af"/><circle cx="400" cy="150" r="35" fill="#b1bfca"/><circle cx="150" cy="400" r="35" fill="#b1bfca"/><circle cx="650" cy="400" r="35" fill="#b1bfca"/><circle cx="400" cy="650" r="35" fill="#b1bfca"/><line x1="400" y1="400" x2="200" y2="200" stroke="#d4dce3" stroke-width="3"/><line x1="400" y1="400" x2="600" y2="200" stroke="#d4dce3" stroke-width="3"/><line x1="400" y1="400" x2="200" y2="600" stroke="#d4dce3" stroke-width="3"/><line x1="400" y1="400" x2="600" y2="600" stroke="#d4dce3" stroke-width="3"/><line x1="400" y1="400" x2="400" y2="150" stroke="#d4dce3" stroke-width="3"/><line x1="400" y1="400" x2="150" y2="400" stroke="#d4dce3" stroke-width="3"/><line x1="400" y1="400" x2="650" y2="400" stroke="#d4dce3" stroke-width="3"/><line x1="400" y1="400" x2="400" y2="650" stroke="#d4dce3" stroke-width="3"/><line x1="200" y1="200" x2="400" y2="150" stroke="#eceef1" stroke-width="2"/><line x1="600" y1="200" x2="400" y2="150" stroke="#eceef1" stroke-width="2"/><line x1="200" y1="600" x2="150" y2="400" stroke="#eceef1" stroke-width="2"/><line x1="600" y1="600" x2="650" y2="400" stroke="#eceef1" stroke-width="2"/></svg>',
